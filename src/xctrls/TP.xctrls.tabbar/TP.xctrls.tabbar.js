...
TP.xctrls.tabbar.Type.set('bidiAttrs', TP.ac('value'));

//  ------------------------------------------------------------------------
//  Type Methods
//  ------------------------------------------------------------------------

TP.xctrls.tabbar.Type.defineMethod('tagAttachComplete',
function(aRequest) {
...
TP.xctrls.tabbar.Type.defineMethod('tagAttachDOM',
function(aRequest) {
...
TP.xctrls.tabbar.Inst.defineAttribute('$dataKeys');

//  The data as massaged into what this control needs. This is reset whenever
//  the control's whole data set is reset.
TP.xctrls.tabbar.Inst.defineAttribute('$convertedData');

TP.xctrls.tabbar.Inst.defineAttribute(
    'tabcontent',
    TP.cpc('> tibet|group .content', TP.hc('shouldCollapse', true)));

TP.xctrls.tabbar.Inst.defineAttribute(
    'tabitems',
    TP.cpc('> tibet|group .content > xctrls|*', TP.hc('shouldCollapse', false)));

TP.xctrls.tabbar.Inst.defineAttribute(
    'focusedItem',
    TP.cpc('> tibet|group .content > xctrls|*[pclass|focus]',
...
TP.xctrls.tabbar.Inst.defineMethod('allowsMultiples',
function() {
...
TP.xctrls.tabbar.Inst.defineMethod('getValue',
function() {
...
TP.xctrls.tabbar.Inst.defineMethod('focus',
function(moveAction) {
...
TP.xctrls.tabbar.Inst.defineMethod('isScalarValued',
function(aspectName) {
...
TP.xctrls.tabbar.Inst.defineMethod('refresh',
...
TP.xctrls.tabbar.Inst.defineMethod('$refreshSelectionModelFor',
function(anAspect) {
...
TP.xctrls.tabbar.Inst.defineMethod('setAttrId',
function(anID) {
...
TP.xctrls.tabbar.Inst.defineMethod('setData',
...
TP.xctrls.tabbar.Inst.defineMethod('setValue',
...
TP.xctrls.tabbar.Inst.defineMethod('stylesheetReady',
...
TP.xctrls.tabbar.Inst.defineMethod('computeSelectionData',
function() {
...
TP.xctrls.tabbar.Inst.defineMethod('getKeyFunction',
function() {
...
TP.xctrls.tabbar.Inst.defineMethod('getRootUpdateSelection',
...
TP.xctrls.tabbar.Inst.defineMethod('getSelectionContainer',
function() {
...
TP.xctrls.tabbar.Inst.defineMethod('getTemplate',
function() {
...
TP.xctrls.tabbar.Inst.defineMethod('finishUpdatingExistingContent',
function(selection) {
...
TP.xctrls.tabbar.Inst.defineMethod('updateExistingContent',
