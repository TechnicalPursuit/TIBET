...
function(aRequest) {
    ...
    if (TP.isValid(templateTPElem)) {
        ...
        //  If there was a valid 'templateexpr' span (as generated by ACP
        //  expressions), then use that to place the standin. Otherwise, just
        //  use the content element.
        if (TP.isValid(contentTemplateExprTPElem)) {
            templateParentElem = contentTemplateExprTPElem.getNativeNode();
        } else {
