 ...
 * @synopsis A value whose range is limited by unsigned 32-bit storage limits.
 */
...
function(anObject) {
    ...
    /**
     * @name validate
     * @synopsis Returns true if the object provided falls between 0 and
