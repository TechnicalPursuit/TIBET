...
TP.html.tcell.Type.set('booleanAttrs',
        TP.html.tcell.Type.get('booleanAttrs').concat(
            TP.ac('noWrap')));
...
TP.html.table.Type.set('booleanAttrs',
        TP.html.table.Type.get('booleanAttrs').concat(
            TP.ac('sortable')));
