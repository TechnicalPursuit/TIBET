            ...
            default:
                ...
                if (this.getAttribute('type') === TP.ietf.mime.TIBET_CSS) {
                    ...
                    if (!TP.isElement(existingStyleElem)) {
                        ...
                        TP.documentAddCSSLinkElement(
                                    doc,
                                    hrefLocation,
                                    this.getNativeNode().nextSibling).then(
                            function(newStyleElem) {

                                TP.elementSetAttribute(
                                    newStyleElem, 'id', generatedStyleID, true);

                                //  Set an attribute on our newly created style
                                //  element that links it back to the source
                                //  element.
                                ...
                                //  Track the original source from the URI -
                                //  this is what the author originally typed and
                                //  might be a virtual URI. We'd like to track
                                //  it here.
                                TP.elementSetAttribute(inlinedStyleElem,
                                                        'tibet:originalhref',
                                                        hrefLocation,
