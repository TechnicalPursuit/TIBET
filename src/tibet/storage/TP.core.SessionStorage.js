...
/**
 * @type {TP.core.SessionStorage}
 * @summary A subtype of TP.core.DeviceStorage for handling 'session storage'
 *     persistence mechanisms.
 */

//  ------------------------------------------------------------------------

TP.core.DeviceStorage.defineSubtype('SessionStorage');

//  ------------------------------------------------------------------------
//  Type Methods
//  ------------------------------------------------------------------------

TP.core.SessionStorage.Type.defineMethod('canConstruct',
function() {
    ...
    //  Webkit-based and Mozilla-based browsers actually support 'sessionStorage'
...
TP.core.SessionStorage.Inst.defineMethod('at',
function(aKey) {
...
TP.core.SessionStorage.Inst.defineMethod('atPut',
...
TP.core.SessionStorage.Inst.defineMethod('empty',
function() {
...
TP.core.SessionStorage.Inst.defineMethod('removeKey',
function(aKey) {
