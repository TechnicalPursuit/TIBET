...
/**
 * @type {TP.sherpa.formBuilderAssistant}
 */

//  ------------------------------------------------------------------------

TP.tag.CustomTag.defineSubtype('sherpa.formBuilderAssistant');

//  Note how this property is TYPE_LOCAL, by design.
TP.sherpa.formBuilderAssistant.defineAttribute('themeURI', TP.NO_RESULT);

//  ------------------------------------------------------------------------
//  Instance Attributes
//  ------------------------------------------------------------------------

TP.sherpa.formBuilderAssistant.Inst.defineAttribute('head',
    TP.cpc('> .head', TP.hc('shouldCollapse', true)));

TP.sherpa.formBuilderAssistant.Inst.defineAttribute('body',
    TP.cpc('> .body', TP.hc('shouldCollapse', true)));

TP.sherpa.formBuilderAssistant.Inst.defineAttribute('foot',
    TP.cpc('> .foot', TP.hc('shouldCollapse', true)));

TP.sherpa.formBuilderAssistant.Inst.defineAttribute('data');

//  ------------------------------------------------------------------------
//  Type Methods
//  ------------------------------------------------------------------------

TP.sherpa.formBuilderAssistant.Type.defineMethod('showAssistant',
function(assistantData) {
    ...
    //  Grab the TP.sherpa.formBuilderAssistant type's template.
    assistantContentTPElem =
        TP.sherpa.formBuilderAssistant.getResourceElement(
                        'template',
                        TP.ietf.mime.XHTML);
...
TP.sherpa.formBuilderAssistant.Inst.defineMethod('generatePathData',
function(anElement) {
     ...
     * @returns {TP.sherpa.formBuilderAssistant} The receiver.
     */
...
TP.sherpa.formBuilderAssistant.Inst.defineHandler('DialogCancel',
function(anObject) {
...
TP.sherpa.formBuilderAssistant.Inst.defineHandler('DialogOk',
function(anObject) {
...
TP.sherpa.formBuilderAssistant.Inst.defineMethod('setData',
function(anObj) {
