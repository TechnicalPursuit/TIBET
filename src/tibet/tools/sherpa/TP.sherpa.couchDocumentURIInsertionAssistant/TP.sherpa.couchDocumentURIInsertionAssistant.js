...
TP.sherpa.couchDocumentURIInsertionAssistant.Type.defineMethod('showAssistant',
function(assistantData) {
     ...
     * @returns {TP.meta.sherpa.couchDocumentURIInsertionAssistant} The receiver.
     */

    var assistantContentTPElem,
        dialogPromise;

    //  Grab the TP.sherpa.couchViewURIInsertionAssistant type's template.
