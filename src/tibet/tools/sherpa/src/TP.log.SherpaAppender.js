...
/**
 * @type {TP.log.SherpaAppender}
 */

//  ----------------------------------------------------------------------------

TP.log.Appender.defineSubtype('SherpaAppender');

//  ----------------------------------------------------------------------------
//  Type Attributes
//  ----------------------------------------------------------------------------

TP.log.SherpaAppender.Type.$set('defaultLayoutType', 'TP.log.SherpaLayout');

//  ----------------------------------------------------------------------------
//  Instance Definition
//  ----------------------------------------------------------------------------

TP.log.SherpaAppender.Inst.defineMethod('append',
function(anEntry) {
     ...
     * @returns {TP.log.SherpaAppender} The receiver.
     */
