...
/**
 * @type {TP.sherpa.count}
 */

//  ------------------------------------------------------------------------

TP.sherpa.Element.defineSubtype('count');

//  ------------------------------------------------------------------------
//  Instance Attributes
//  ------------------------------------------------------------------------

TP.sherpa.count.Inst.defineAttribute('countNumber',
...
TP.sherpa.count.Inst.defineMethod('getContent',
function(aRequest) {
...
TP.sherpa.count.Inst.defineMethod('setContent',
