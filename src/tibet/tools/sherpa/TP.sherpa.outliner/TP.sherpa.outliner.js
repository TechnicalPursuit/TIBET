...
function(aSignal) {
    ...
    //  Add a 'sherpa_outliner-tagname' attribute on the target and all of its
...
function() {
    ...
    //  Remove the 'sherpa_outliner-tagname' attribute on the target and all of
    //  its descendants. This is used by a CSS rule to display the tagname
    //  labels for each element in the outline.
    TP.elementRemoveAttribute(targetElement, 'sherpa_outliner-tagname', true);
    TP.nodeDescendantElementsPerform(
                    targetElement,
                    function(anElement) {
                        TP.elementRemoveAttribute(
                            anElement, 'sherpa_outliner-tagname', true);
                        TP.elementRemoveAttribute(
