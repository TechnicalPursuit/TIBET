...
//  ========================================================================
//  TP.sherpa.TWSRootInspectorSource
//  ========================================================================

/**
 * @type {TP.sherpa.TWSRootInspectorSource}
 */

TP.sherpa.InspectorSource.defineSubtype('sherpa.TWSRootInspectorSource');
...
TP.sherpa.TWSRootInspectorSource.Inst.defineMethod('getConfigForInspector',
function(options) {
...
TP.sherpa.TWSRootInspectorSource.Inst.defineMethod('getContentForInspector',
function(options) {
    ...
    return TP.xhtmlnode(
            '<div class="wrapped noselect usermessage">' +
                ...
                'sherpa_tws">Coming Soon</a>' +
            '</div>');
});

//  ------------------------------------------------------------------------

TP.sherpa.TWSRootInspectorSource.Inst.defineMethod('getDataForInspector',
function(options) {
