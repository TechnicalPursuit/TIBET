...
//  ========================================================================
//  TP.sherpa.TIBETSessionStorageListInspectorSource
//  ========================================================================

/**
 * @type {TP.sherpa.TIBETSessionStorageListInspectorSource}
 */

TP.sherpa.InspectorSource.defineSubtype(
                            'sherpa.TIBETSessionStorageListInspectorSource');
...
TP.sherpa.TIBETSessionStorageListInspectorSource.Inst.defineMethod(
'getDataForInspector',
function(options) {
    ...
    sourceEntries = TP.hc(top.sessionStorage);
