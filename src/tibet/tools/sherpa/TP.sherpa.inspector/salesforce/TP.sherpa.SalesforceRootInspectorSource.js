...
/**
 * @type {TP.sherpa.SalesforceRootInspectorSource}
 */

//  ------------------------------------------------------------------------

TP.sherpa.InspectorSource.defineSubtype('sherpa.SalesforceRootInspectorSource');

//  ------------------------------------------------------------------------
//  Inspector API
//  ------------------------------------------------------------------------

TP.sherpa.SalesforceRootInspectorSource.Inst.defineMethod('getDataForInspector',
function(options) {
    ...
    servicesConfig = TP.sys.getcfg('salesforce.known_services');
...
TP.sherpa.SalesforceRootInspectorSource.Inst.defineMethod('resolveAspectForInspector',
function(anAspect, options) {
    ...
    newInspector = TP.sherpa.SalesforceSubInspectorSources.construct();
