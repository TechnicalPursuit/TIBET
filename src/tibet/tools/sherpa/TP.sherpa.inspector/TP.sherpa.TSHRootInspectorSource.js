...
//  ========================================================================
//  TP.sherpa.TSHRootInspectorSource
//  ========================================================================

/**
 * @type {TP.sherpa.TSHRootInspectorSource}
 */

TP.sherpa.InspectorSource.defineSubtype('sherpa.TSHRootInspectorSource');
...
TP.sherpa.TSHRootInspectorSource.Inst.defineMethod('getConfigForInspector',
function(options) {
...
TP.sherpa.TSHRootInspectorSource.Inst.defineMethod('getContentForInspector',
function(options) {
...
TP.sherpa.TSHRootInspectorSource.Inst.defineMethod('getDataForInspector',
function(options) {
