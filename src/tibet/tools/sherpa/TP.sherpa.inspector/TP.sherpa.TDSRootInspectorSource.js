...
//  ========================================================================
//  TP.sherpa.TDSRootInspectorSource
//  ========================================================================

/**
 * @type {TP.sherpa.TDSRootInspectorSource}
 */

TP.sherpa.InspectorSource.defineSubtype('sherpa.TDSRootInspectorSource');
...
TP.sherpa.TDSRootInspectorSource.Inst.defineMethod('getConfigForInspector',
function(options) {
...
TP.sherpa.TDSRootInspectorSource.Inst.defineMethod('getContentForInspector',
function(options) {
    ...
    return TP.xhtmlnode(
            '<div class="wrapped noselect usermessage">' +
                ...
                'sherpa_tds">Coming Soon</a>' +
            '</div>');
});

//  ------------------------------------------------------------------------

TP.sherpa.TDSRootInspectorSource.Inst.defineMethod('getDataForInspector',
function(options) {
