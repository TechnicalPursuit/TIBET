...
//  ========================================================================
//  TP.sherpa.TIBETRouteListInspectorSource
//  ========================================================================

/**
 * @type {TP.sherpa.TIBETRouteListInspectorSource}
 */

TP.sherpa.InspectorSource.defineSubtype(
                            'sherpa.TIBETRouteListInspectorSource');
...
TP.sherpa.TIBETRouteListInspectorSource.Inst.defineMethod(
'getDataForInspector',
function(options) {
