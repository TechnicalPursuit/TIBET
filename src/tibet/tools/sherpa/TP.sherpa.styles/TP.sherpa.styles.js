...
TP.sherpa.styles.Inst.defineMethod('buildNewContent',
...
TP.sherpa.styles.Inst.defineMethod('computeSelectionData',
function() {
...
TP.sherpa.styles.Inst.defineMethod('getKeyFunction',
function() {
...
TP.sherpa.styles.Inst.defineMethod('getRootUpdateSelection',
...
TP.sherpa.styles.Inst.defineMethod('getSelectionContainer',
function() {
...
TP.sherpa.styles.Inst.defineMethod('updateExistingContent',
