...
//  ========================================================================
//  TP.lama.TWSRootInspectorSource
//  ========================================================================

/**
 * @type {TP.lama.TWSRootInspectorSource}
 */

TP.lama.InspectorSource.defineSubtype('lama.TWSRootInspectorSource');
...
TP.lama.TWSRootInspectorSource.Inst.defineMethod('getConfigForInspector',
function(options) {
...
TP.lama.TWSRootInspectorSource.Inst.defineMethod('getContentForInspector',
function(options) {
    ...
    return TP.xhtmlnode(
            '<div class="wrapped noselect usermessage">' +
                ...
                'lama_tws">Coming Soon</a>' +
            '</div>');
});

//  ------------------------------------------------------------------------

TP.lama.TWSRootInspectorSource.Inst.defineMethod('getDataForInspector',
function(options) {
