...
/**
 * @type {TP.lama.SalesforceSubInspectorSources}
 */

//  ------------------------------------------------------------------------

TP.lama.InspectorPathSource.defineSubtype('lama.SalesforceSubInspectorSources');

//  ------------------------------------------------------------------------
//  Type Methods
//  ------------------------------------------------------------------------

TP.lama.SalesforceSubInspectorSources.Type.defineMethod('initialize',
function() {
...
TP.lama.SalesforceSubInspectorSources.Inst.defineAttribute('$query');

//  ------------------------------------------------------------------------
//  Instance Methods
//  ------------------------------------------------------------------------

TP.lama.SalesforceSubInspectorSources.Inst.defineMethod('init',
function() {

    /**
     * @method init
     * @summary Initialize the instance.
     * @returns {TP.lama.SalesforceSubInspectorSources} The receiver.
     */
...
TP.lama.SalesforceSubInspectorSources.Inst.defineHandler('QuerySalesforce',
function() {
     ...
     * @returns {TP.lama.SalesforceDBSubInspectorSources} The receiver.
     */
...
TP.lama.SalesforceSubInspectorSources.Inst.defineMethod('getConfigForInspectorForSFQuery',
function(options) {
...
TP.lama.SalesforceSubInspectorSources.Inst.defineMethod('getConfigForInspectorForSFQueryResults',
function(options) {
...
TP.lama.SalesforceSubInspectorSources.Inst.defineMethod('getContentForInspectorForSFQuery',
function(options) {
    ...
    queryPanelLoc =
        TP.uc('~ide_root/TP.lama.inspector/salesforce/query_panel.xhtml').
        getLocation();
...
TP.lama.SalesforceSubInspectorSources.Inst.defineMethod('getContentForInspectorForSFQueryResults',
function(options) {
...
TP.lama.SalesforceSubInspectorSources.Inst.defineMethod('getDataForInspectorForSFQuery',
function(options) {
...
TP.lama.SalesforceSubInspectorSources.Inst.defineMethod('getDataForInspectorForSFQueryResults',
function(options) {
