...
//  ========================================================================
//  TP.lama.TSHRootInspectorSource
//  ========================================================================

/**
 * @type {TP.lama.TSHRootInspectorSource}
 */

TP.lama.InspectorSource.defineSubtype('lama.TSHRootInspectorSource');
...
TP.lama.TSHRootInspectorSource.Inst.defineMethod('getConfigForInspector',
function(options) {
...
TP.lama.TSHRootInspectorSource.Inst.defineMethod('getContentForInspector',
function(options) {
    ...
    return TP.xhtmlnode(
            '<div class="wrapped noselect usermessage">' +
                ...
                'lama_tsh">Coming Soon</a>' +
            '</div>');
});

//  ------------------------------------------------------------------------

TP.lama.TSHRootInspectorSource.Inst.defineMethod('getDataForInspector',
function(options) {
