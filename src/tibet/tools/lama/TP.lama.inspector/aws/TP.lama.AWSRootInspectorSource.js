...
/**
 * @type {TP.lama.AWSRootInspectorSource}
 */

//  ------------------------------------------------------------------------

TP.lama.InspectorSource.defineSubtype('lama.AWSRootInspectorSource');

//  ------------------------------------------------------------------------
//  Inspector API
//  ------------------------------------------------------------------------

TP.lama.AWSRootInspectorSource.Inst.defineMethod('getDataForInspector',
function(options) {
...
TP.lama.AWSRootInspectorSource.Inst.defineMethod('resolveAspectForInspector',
function(anAspect, options) {
    ...
    newInspector = TP.lama.AWSSubInspectorSources.construct();
