...
/**
 * @type {TP.lama.AWSSubInspectorSources}
 */

//  ------------------------------------------------------------------------

TP.lama.InspectorPathSource.defineSubtype('lama.AWSSubInspectorSources');

//  ------------------------------------------------------------------------
//  Type Methods
//  ------------------------------------------------------------------------

TP.lama.AWSSubInspectorSources.Type.defineMethod('initialize',
function() {
    ...
    this.defineDependencies('TP.extern.AWS');
...
TP.lama.AWSSubInspectorSources.Inst.defineAttribute('$authInfoRequest');
TP.lama.AWSSubInspectorSources.Inst.defineAttribute('$showAuthContent');

TP.lama.AWSSubInspectorSources.Inst.defineAttribute('s3BucketName');
TP.lama.AWSSubInspectorSources.Inst.defineAttribute('s3ObjectName');

TP.lama.AWSSubInspectorSources.Inst.defineAttribute('lambdaFunctionName');

//  ------------------------------------------------------------------------
//  Instance Methods
//  ------------------------------------------------------------------------

TP.lama.AWSSubInspectorSources.Inst.defineMethod('init',
function() {

    /**
     * @method init
     * @summary Initialize the instance.
     * @returns {TP.lama.AWSSubInspectorSources} The receiver.
     */
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('checkAuthentication',
function() {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getAuthenticationContent',
function(options) {
    ...
    authPanelLoc =
        TP.uc('~ide_root/TP.lama.inspector/aws/auth_panel.xhtml').
        getLocation();
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getContentForInspector',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineHandler('AuthenticateConnection',
function() {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getConfigForInspectorForS3Designation',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getConfigForInspectorForS3AllBuckets',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getConfigForInspectorForS3BucketContent',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getConfigForInspectorForS3ObjectContent',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getConfigForInspectorForLambdaDesignation',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getConfigForInspectorForLambdaAllFunctions',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getConfigForInspectorForLambdaFunctionInfo',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getContentForInspectorForS3ObjectContent',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getContentForInspectorForLambdaFunctionInfo',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getDataForInspectorForS3Designation',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getDataForInspectorForS3AllBuckets',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getDataForInspectorForS3BucketContent',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getDataForInspectorForS3ObjectContent',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getDataForInspectorForLambdaDesignation',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getDataForInspectorForLambdaAllFunctions',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getDataForInspectorForLambdaFunctionInfo',
function(options) {
...
TP.lama.AWSSubInspectorSources.Inst.defineMethod('getChildTypeForCanvasForLambdaFunctionInfo',
function(options) {
