...
//  ========================================================================
//  TP.lama.TIBETTypeListInspectorSource
//  ========================================================================

/**
 * @type {TP.lama.TIBETTypeListInspectorSource}
 */

TP.lama.InspectorSource.defineSubtype(
                            'lama.TIBETTypeListInspectorSource');

//  ------------------------------------------------------------------------
//  Instance Methods
//  ------------------------------------------------------------------------

TP.lama.TIBETTypeListInspectorSource.Inst.defineHandler(
...
TP.lama.TIBETTypeListInspectorSource.Inst.defineMethod(
'getDataForInspector',
function(options) {
...
TP.lama.TIBETTypeListInspectorSource.Inst.defineMethod('getEntryAt',
...
TP.lama.TIBETTypeListInspectorSource.Inst.defineMethod('getContentForToolbar',
function(options) {
