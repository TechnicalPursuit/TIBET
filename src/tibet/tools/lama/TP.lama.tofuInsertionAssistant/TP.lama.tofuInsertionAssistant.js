...
/**
 * @type {TP.lama.tofuInsertionAssistant}
 */

//  ------------------------------------------------------------------------

TP.tag.CustomTag.defineSubtype('lama.tofuInsertionAssistant');

//  Note how this property is TYPE_LOCAL, by design.
TP.lama.tofuInsertionAssistant.defineAttribute('themeURI', TP.NO_RESULT);

//  ------------------------------------------------------------------------
//  Instance Attributes
//  ------------------------------------------------------------------------

TP.lama.tofuInsertionAssistant.Inst.defineAttribute('head',
    TP.cpc('> .head', TP.hc('shouldCollapse', true)));

TP.lama.tofuInsertionAssistant.Inst.defineAttribute('body',
    TP.cpc('> .body', TP.hc('shouldCollapse', true)));

TP.lama.tofuInsertionAssistant.Inst.defineAttribute('foot',
    TP.cpc('> .foot', TP.hc('shouldCollapse', true)));

TP.lama.tofuInsertionAssistant.Inst.defineAttribute('generatedTag',
    TP.cpc('> .foot > #generatedTag', TP.hc('shouldCollapse', true)));

TP.lama.tofuInsertionAssistant.Inst.defineAttribute('data');

//  ------------------------------------------------------------------------
//  Type Methods
//  ------------------------------------------------------------------------

TP.lama.tofuInsertionAssistant.Type.defineMethod('showAssistant',
function(assistantData) {
     ...
     *          the new DOM node.
     * @returns {TP.meta.lama.tofuInsertionAssistant} The receiver.
     */

    var assistantContentTPElem,
        dialogPromise;

    //  Grab the TP.lama.tofuInsertionAssistant type's template.
    assistantContentTPElem =
        TP.lama.tofuInsertionAssistant.getResourceElement(
                        'template',
                        TP.ietf.mime.XHTML);
...
TP.lama.tofuInsertionAssistant.Inst.defineMethod('generatePathData',
function(anElement) {
     ...
     * @returns {TP.lama.tofuInsertionAssistant} The receiver.
     */
...
TP.lama.tofuInsertionAssistant.Inst.defineMethod('generateTag',
...
TP.lama.tofuInsertionAssistant.Inst.defineHandler('DialogCancel',
function(anObject) {
...
TP.lama.tofuInsertionAssistant.Inst.defineHandler('DialogOk',
function(anObject) {
    ...
    autodefineMissingTags = TP.sys.cfg('lama.autodefine_missing_tags');
    ...
    TP.sys.setcfg('lama.autodefine_missing_tags', autodefineMissingTags);
...
TP.lama.tofuInsertionAssistant.Inst.defineHandler('ValueChange',
function(aSignal) {
...
TP.lama.tofuInsertionAssistant.Inst.defineMethod('setData',
function(anObj) {
