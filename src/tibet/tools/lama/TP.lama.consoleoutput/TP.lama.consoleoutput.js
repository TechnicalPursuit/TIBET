...
/**
 * @type {TP.lama.consoleoutputoutput}
 */

//  ------------------------------------------------------------------------

TP.lama.TemplatedTag.defineSubtype('consoleoutput');

//  ------------------------------------------------------------------------
//  Instance Attributes
//  ------------------------------------------------------------------------

TP.lama.consoleoutput.Inst.defineAttribute('$inlineStyleElem');

TP.lama.consoleoutput.Inst.defineAttribute('rawOutEntryTemplate');

TP.lama.consoleoutput.Inst.defineAttribute('outputCoalesceEntries');
TP.lama.consoleoutput.Inst.defineAttribute('outputCoalesceLock');

TP.lama.consoleoutput.Inst.defineAttribute('wrapper',
    TP.cpc('> .wrapper', TP.hc('shouldCollapse', true)));

TP.lama.consoleoutput.Inst.defineAttribute('outputItemsContents',
    TP.cpc('lama|consoleoutputitem > .flex-item > .content'));

//  ------------------------------------------------------------------------
//  Instance Methods
//  ------------------------------------------------------------------------

TP.lama.consoleoutput.Inst.defineMethod('setup',
function() {

    /**
     * @method setup
     * @summary Perform the initial setup for the TP.lama.consoleoutput
     *     object.
     * @returns {TP.lama.consoleoutput} The receiver.
     */
    ...
    //  Manually add TP.lama.scrollbutton's stylesheet to our document, since
    //  we don't awaken item content for performance reasons.
    TP.lama.scrollbutton.addStylesheetTo(this.getNativeDocument());
...
TP.lama.consoleoutput.Inst.defineHandler('PclassClosedChange',
function(aSignal) {
...
TP.lama.consoleoutput.Inst.defineHandler('DOMDNDInitiate',
function(aSignal) {
...
TP.lama.consoleoutput.Inst.defineHandler('DOMDNDTerminate',
function(aSignal) {
...
TP.lama.consoleoutput.Inst.defineHandler('DOMResize',
function(aSignal) {
...
TP.lama.consoleoutput.Inst.defineMethod('adjustItemMaxHeight',
function() {
     ...
     * @returns {TP.lama.console} The receiver.
     */
    ...
    offset =
        20 +    //  lama:consoleoutput top & bottom values
        7 +     //  lama:consoleoutputitem top & bottom margin values
...
TP.lama.consoleoutput.Inst.defineMethod('clear',
function() {
    ...
    outputItems = TP.byCSSPath('> .wrapper > lama|consoleoutputitem',
                                this,
                                false,
                                true);
    outputItems.forEach(
...
TP.lama.consoleoutput.Inst.defineMethod('createOutputItem',
function(uniqueID, dataRecord) {
    ...
    //  Grab the proper template for a console item from the Lama' shared
    ...
    //  history ID, etc.
    resp = TP.uc('~ide_root/xhtml/lama_console_templates.xhtml' +
...
TP.lama.consoleoutput.Inst.defineMethod('createTiledOutput',
function(itemElem, uniqueID, dataRecord) {
    ...
    tileTPElem = TP.bySystemId('Lama').makeTile(tileID);
...
TP.lama.consoleoutput.Inst.defineMethod('getInputStats',
function(aSignal) {
...
TP.lama.consoleoutput.Inst.defineMethod('getOutputTypeInfo',
function(aSignal) {
...
TP.lama.consoleoutput.Inst.defineMethod('growlModeForceDisplayToggle',
function() {
...
TP.lama.consoleoutput.Inst.defineHandler('ShowTile',
function(aSignal) {
...
TP.lama.consoleoutput.Inst.defineMethod('scrollOutputToEnd',
function() {
...
TP.lama.consoleoutput.Inst.defineMethod('toggleObservations',
...
TP.lama.consoleoutput.Inst.defineMethod('updateOutputItem',
function(uniqueID, dataRecord) {
    ...
    if (this.getAttribute('mode') === 'none' &&
        ...
        (function() {
            ...
            styleObj.transitionDelay =
                TP.sys.cfg('lama.tdc.item_fadeout_delay', 2000) + 'ms';
            styleObj.transitionDuration =
                TP.sys.cfg('lama.tdc.item_fadeout_duration', 2000) + 'ms';
    ...
    if (TP.notValid(rawOutEntryTemplate = this.get('rawOutEntryTemplate'))) {
        resp = TP.uc(
            '~ide_root/xhtml/lama_console_templates.xhtml' +
...
//  ========================================================================
//  TP.lama.consoleoutputitem
//  ========================================================================

TP.lama.Element.defineSubtype('consoleoutputitem');
...
//  CSS from TP.lama.Element. Note how this property is TYPE_LOCAL, by design.
TP.lama.consoleoutputitem.defineAttribute('styleURI', TP.NO_RESULT);
...
TP.lama.consoleoutputitem.Inst.defineAttribute('$creatingRequest');

//  ------------------------------------------------------------------------
//  Instance Methods
//  ------------------------------------------------------------------------

TP.lama.consoleoutputitem.Inst.defineHandler('DOMScroll',
function(aSignal) {
     ...
     *     this method.
     * @returns {TP.lama.consoleoutputitem} The receiver.
     */
...
TP.lama.consoleoutputitem.Inst.defineMethod('setup',
function() {
    ...
    arrows = TP.byCSSPath(' lama|scrollbutton',
                            this.getNativeNode(),
                            false,
                            true);
...
TP.lama.consoleoutputitem.Inst.defineMethod('teardown',
function() {
...
TP.lama.consoleoutputitem.Inst.defineMethod('updateScrollButtons',
function() {
