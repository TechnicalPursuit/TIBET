...
/**
 * @type {TP.lama.adjuster_genericPropertyEditor}
 */

//  ------------------------------------------------------------------------

TP.lama.adjuster_editor.defineSubtype('adjuster_genericPropertyEditor');

//  ------------------------------------------------------------------------
//  Instance Attributes
//  ------------------------------------------------------------------------

TP.lama.adjuster_genericPropertyEditor.Inst.defineAttribute(
    'propertyName',
...
TP.lama.adjuster_genericPropertyEditor.Inst.defineMethod('generateCSSData',
function() {
...
TP.lama.adjuster_genericPropertyEditor.Inst.defineMethod(
...
function(infoData, mainPropName, aSlotName) {
    ...
    if (TP.isValid(infoData.match)) {
        ...
        switch (slotType) {
            ...
            case 'Dimension':
                str += ' tibet:tag="lama:CSSDimensionSlotEditor"';
            ...
            case 'Identifier':
                ...
                if (TP.CSS_COLOR_NAMES.at(slotVal)) {
                    str += ' tibet:tag="lama:CSSColorSlotEditor"';
                    slotVal = TP.CSS_COLOR_NAMES.at(slotVal);
                } else {
                    str += ' tibet:tag="lama:CSSIdentifierSlotEditor"';
                }
                break;

            case 'Percentage':
                str += ' tibet:tag="lama:CSSPercentageSlotEditor"';
                break;
            ...
            case 'Number':
            case 'String':
                str += ' tibet:tag="lama:CSSSlotEditor"';
                break;
...
function(slotName) {
    ...
    adjusterTPElem = TP.byId('LamaAdjuster', this.getNativeDocument());
...
TP.lama.adjuster_genericPropertyEditor.Inst.defineHandler('HideGuides',
function(aSignal) {
     ...
     *     method.
     * @returns {TP.lama.adjuster_genericPropertyEditor} The receiver.
     */
...
TP.lama.adjuster_genericPropertyEditor.Inst.defineHandler('ShowGuides',
function(aSignal) {
...
TP.lama.adjuster_genericPropertyEditor.Inst.defineHandler('ShowNameMenu',
function(aSignal) {
    ...
    TP.uc('urn:tibet:lama_adjuster_name_menu_data').setResource(data);
    ...
    this.signal(
        'TogglePopup',
        TP.hc(
            'contentURI', 'urn:tibet:TP.lama.adjusterNameMenuContent',
...
TP.lama.adjuster_genericPropertyEditor.Inst.defineHandler(
...
TP.lama.adjuster_genericPropertyEditor.Inst.defineMethod('hideVisualGuides',
function() {
...
TP.lama.adjuster_genericPropertyEditor.Inst.defineMethod('render',
function() {
...
TP.lama.adjuster_genericPropertyEditor.Inst.defineMethod('showVisualGuides',
function() {
...
TP.lama.adjuster_genericPropertyEditor.Inst.defineMethod('updateVisualGuides',
function() {
...
TP.lama.adjuster_genericPropertyEditor.Inst.defineMethod('updateRuleValue',
...
//  ========================================================================
//  TP.lama.CSSSlotEditor
//  ========================================================================

/**
 * @type {TP.lama.CSSSlotEditor}
 */

//  ------------------------------------------------------------------------

TP.lama.ComputedTag.defineSubtype('CSSSlotEditor');
...
TP.lama.CSSSlotEditor.Type.defineAttribute('styleURI', TP.NO_RESULT);
TP.lama.CSSSlotEditor.Type.defineAttribute('themeURI', TP.NO_RESULT);

//  ------------------------------------------------------------------------
//  Instance Attributes
//  ------------------------------------------------------------------------

TP.lama.CSSSlotEditor.Inst.defineAttribute(
    'valuePart',
...
TP.lama.CSSSlotEditor.Inst.defineMethod('completeUpdatingRule',
function(updateRuleSource, adjustHalo) {
     ...
     * @param {Boolean} [adjustHalo=true] Whether or not to adjust the halo to
     *     match any dimension or position style changes.
     * @returns {TP.lama.CSSSlotEditor} The receiver.
     */
...
TP.lama.CSSSlotEditor.Inst.defineMethod('getAdjusterEditorElement',
function() {

    /**
     * @method getAdjusterEditorElement
     * @summary Returns the adjuster editor that contains this slot editor.
     * @returns {TP.lama.CSSSlotEditor} The adjuster editor that contains
     *     the receiver.
     */

    return this.getFirstAncestorBySelector('lama|adjuster_genericPropertyEditor');
});

//  ------------------------------------------------------------------------

TP.lama.CSSSlotEditor.Inst.defineMethod('getValueForCSSRule',
function() {
...
TP.lama.CSSSlotEditor.Inst.defineMethod('updateRule',
function() {
...
//  ========================================================================
//  TP.lama.CSSColorSlotEditor
//  ========================================================================

/**
 * @type {TP.lama.CSSColorSlotEditor}
 */

//  ------------------------------------------------------------------------

TP.lama.CSSSlotEditor.defineSubtype('CSSColorSlotEditor');
...
//  This tag has no associated CSS. Note how these properties are *not*
//  TYPE_LOCAL, by design.
TP.lama.CSSColorSlotEditor.Type.defineAttribute('styleURI', TP.NO_RESULT);
TP.lama.CSSColorSlotEditor.Type.defineAttribute('themeURI', TP.NO_RESULT);

//  ------------------------------------------------------------------------
//  Instance Attributes
//  ------------------------------------------------------------------------

TP.lama.CSSColorSlotEditor.Inst.defineAttribute(
    'valuePart',
    TP.cpc('> *[part="value"]', TP.hc('shouldCollapse', true)));
...
TP.lama.CSSColorSlotEditor.Inst.defineMethod('getValueForCSSRule',
function() {
...
TP.lama.CSSColorSlotEditor.Inst.defineHandler('PickerValueChange',
function(aSignal) {
     ...
     *     triggered this method.
     * @returns {TP.lama.CSSColorSlotEditor} The receiver.
     */
...
//  ========================================================================
//  TP.lama.CSSDraggableSlotEditor
//  ========================================================================

/**
 * @type {TP.lama.CSSDraggableSlotEditor}
 */

//  ------------------------------------------------------------------------

TP.lama.CSSSlotEditor.defineSubtype('CSSDraggableSlotEditor');

//  ------------------------------------------------------------------------
//  Instance Attributes
//  ------------------------------------------------------------------------

TP.lama.CSSDraggableSlotEditor.Inst.defineAttribute('$lastX');

TP.lama.CSSDraggableSlotEditor.Inst.defineAttribute('curtain',
...
TP.lama.CSSDraggableSlotEditor.Inst.defineMethod('adjustValue',
function(oldX, newX, aDirection, aSignal) {
     ...
     *     of TP.lama.CSSDraggableSlotEditor to adjust the value it is
     *     representing.
     ...
     * @returns {TP.lama.CSSDraggableSlotEditor} The receiver.
     */
...
TP.lama.CSSDraggableSlotEditor.Inst.defineHandler('StartAdjusting',
function(aSignal) {
    ...
    adjuster = TP.byId('LamaAdjuster', this.getNativeDocument());
...
TP.lama.CSSDraggableSlotEditor.Inst.defineHandler('DOMDragMove',
function(aSignal) {
...
TP.lama.CSSDraggableSlotEditor.Inst.defineHandler('DOMDragUp',
function(aSignal) {
...
//  ========================================================================
//  TP.lama.CSSDimensionSlotEditor
//  ========================================================================

/**
 * @type {TP.lama.CSSDimensionSlotEditor}
 */

//  ------------------------------------------------------------------------

TP.lama.CSSDraggableSlotEditor.defineSubtype('CSSDimensionSlotEditor');

//  ------------------------------------------------------------------------
//  Instance Attributes
//  ------------------------------------------------------------------------

TP.lama.CSSDimensionSlotEditor.Inst.defineAttribute(
    'unitPart',
...
TP.lama.CSSDimensionSlotEditor.Inst.defineMethod('adjustValue',
function(oldX, newX, aDirection, aSignal) {
     ...
     * @param {TP.sig.DOMDragMove} aSignal The TIBET signal which was generated
     *     as the dragging process takes place.
     * @returns {TP.lama.CSSDimensionSlotEditor} The receiver.
     */
...
//  ========================================================================
//  TP.lama.CSSIdentifierSlotEditor
//  ========================================================================

/**
 * @type {TP.lama.CSSIdentifierSlotEditor}
 */

//  ------------------------------------------------------------------------

TP.lama.CSSSlotEditor.defineSubtype('CSSIdentifierSlotEditor');
...
TP.lama.CSSIdentifierSlotEditor.Inst.defineHandler('ShowValueMenu',
function(aSignal) {
     ...
     *     this method.
     * @returns {TP.lama.CSSIdentifierSlotEditor} The receiver.
     */
    ...
    TP.uc('urn:tibet:lama_adjuster_value_menu_data').setResource(data);
    ...
    this.signal(
        'TogglePopup',
        TP.hc(
            'contentURI', 'urn:tibet:TP.lama.adjusterValueMenuContent',
            'triggerTPDocument', this.getDocument(),
            'triggerPoint', triggerPoint,
            'hideOn', 'UISelect',
            'triggerID', 'valuemenu',
...
TP.lama.CSSIdentifierSlotEditor.Inst.defineHandler('UIDidHide',
function(aSignal) {
...
TP.lama.CSSIdentifierSlotEditor.Inst.defineHandler('UISelect',
function(aSignal) {
...
TP.lama.CSSIdentifierSlotEditor.Inst.defineHandler('UIValueChange',
function(aSignal) {
...
//  ========================================================================
//  TP.lama.CSSPercentageSlotEditor
//  ========================================================================

/**
 * @type {TP.lama.CSSPercentageSlotEditor}
 */

//  ------------------------------------------------------------------------

TP.lama.CSSDraggableSlotEditor.defineSubtype('CSSPercentageSlotEditor');
...
TP.lama.CSSPercentageSlotEditor.Inst.defineMethod('adjustValue',
function(oldX, newX, aDirection, aSignal) {
     ...
     * @param {TP.sig.DOMDragMove} aSignal The TIBET signal which was generated
     *     as the dragging process takes place.
     * @returns {TP.lama.CSSPercentageSlotEditor} The receiver.
     */
