...
/**
 * @type {TP.lama.adjuster_customPropertyEditor}
 */

//  ------------------------------------------------------------------------

TP.lama.adjuster_genericPropertyEditor.defineSubtype(
...
TP.lama.adjuster_customPropertyEditor.Type.defineMethod('computeResourceURI',
...
TP.lama.adjuster_customPropertyEditor.Inst.defineMethod(
...
function() {
    ...
    //  Grab the common 'tools layer' that the Lama provides.
    toolsLayerElem = TP.bySystemId('Lama').getToolsLayer().getNativeNode();
...
//  ========================================================================
//  TP.lama.adjuster_heightPropertyEditor
//  ========================================================================

/**
 * @type {TP.lama.adjuster_heightPropertyEditor}
 */

//  ------------------------------------------------------------------------

TP.lama.adjuster_customPropertyEditor.defineSubtype(
...
TP.lama.adjuster_heightPropertyEditor.Inst.defineAttribute('$yOffset');

//  ------------------------------------------------------------------------
//  Instance Methods
//  ------------------------------------------------------------------------

TP.lama.adjuster_heightPropertyEditor.Inst.defineMethod('hideVisualGuides',
function() {
     ...
     * @returns {TP.lama.adjuster_heightPropertyEditor} The receiver.
     */
...
TP.lama.adjuster_heightPropertyEditor.Inst.defineMethod('showVisualGuides',
function() {
    ...
    //  Get the offsets from the tools layer to the lama screen containing the
    //  UI canvas document. We'll need to add these offsets to the guide
    //  elements to properly position them as we draw.
    toolsLayerOffsets = TP.bySystemId('Lama').getToolsLayerOffsetsFromScreen(
                                appliedTPElems.first().lamaGetWorldScreen());
...
TP.lama.adjuster_heightPropertyEditor.Inst.defineMethod('updateVisualGuides',
function() {
