...
TP.lama.breadcrumb.Inst.defineAttribute('listcontent',
    TP.cpc('> .content', TP.hc('shouldCollapse', true)));

TP.lama.breadcrumb.Inst.defineAttribute('dataset');

//  ------------------------------------------------------------------------
//  Instance Methods
//  ------------------------------------------------------------------------

TP.lama.breadcrumb.Inst.defineHandler('ItemSelected',
function(aSignal) {
     ...
     *     this method.
     * @returns {TP.lama.breadcrumb} The receiver.
     */
    ...
    if (TP.isElement(target)) {
        itemNumber = TP.elementGetAttribute(target, TP.ITEM_NUM, true);
...
TP.lama.breadcrumb.Inst.defineMethod('buildNewContent',
...
TP.lama.breadcrumb.Inst.defineMethod('getRootUpdateSelection',
...
TP.lama.breadcrumb.Inst.defineMethod('getSelectionContainer',
function() {
...
TP.lama.breadcrumb.Inst.defineMethod('render',
function() {
    ...
    selectorPrefix = 'lama|breadcrumb > .content div.item:nth-child';
...
TP.lama.breadcrumb.Inst.defineMethod('updateDataset',
function(enterSelection) {
...
TP.lama.breadcrumb.Inst.defineMethod('updateExistingContent',
