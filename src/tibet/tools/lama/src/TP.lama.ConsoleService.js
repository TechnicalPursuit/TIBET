...
/**
 * @type {TP.lama.ConsoleService}
 */

//  ----------------------------------------------------------------------------

TP.core.UserIOService.defineSubtype('lama.ConsoleService');
...
TP.lama.ConsoleService.Inst.defineAttribute('$consoleGUI');
...
TP.lama.ConsoleService.Inst.defineAttribute('$multiResults');

//  how many characters wide should the output display be? too large a
//  number here will cause horizontal scrolling.
TP.lama.ConsoleService.Inst.defineAttribute('width', 80);

//  the underlying TP.shell.Shell instance serving as the model for this console
TP.lama.ConsoleService.Inst.defineAttribute('model');

//  are we currently blocking on input from the user
TP.lama.ConsoleService.Inst.defineAttribute('awaitingInput', false);

//  should IO be concealed? this is used to simulate "password" mode
TP.lama.ConsoleService.Inst.defineAttribute('conceal', false);
TP.lama.ConsoleService.Inst.defineAttribute('concealedInput');

//  the last input request processed by the receiver
TP.lama.ConsoleService.Inst.defineAttribute('lastInputRequest');

//  is this a system console, i.e. should it have logging?
TP.lama.ConsoleService.Inst.defineAttribute('systemConsole', false);
...
TP.lama.ConsoleService.Inst.defineAttribute('markingTimer');

//  the ID of the last 'non cmd output item' - usually a logging item that we
//  just want to append to.
TP.lama.ConsoleService.Inst.defineAttribute('lastNonCmdItemID');

//  a state machine handling keyboard states
TP.lama.ConsoleService.Inst.defineAttribute('keyboardStateMachine');

//  ------------------------------------------------------------------------
//  Type Methods
//  ------------------------------------------------------------------------

TP.lama.ConsoleService.Type.defineMethod('construct',
function(aResourceID, aRequest) {
     ...
     * @returns {TP.lama.ConsoleService} A new instance.
     */
    ...
    if (TP.isEmpty(aResourceID)) {
        if (TP.notValid(
                TP.core.Resource.getResourceById('LamaConsoleService'))) {
            name = 'LamaConsoleService';
        } else {
...
TP.lama.ConsoleService.Inst.defineMethod('init',
function(aResourceID, aRequest) {
     ...
     *     name the window and node to use for the console. A consoleTabs
     *     parameter determines whether a tabset is used.
     * @returns {TP.lama.ConsoleService|undefined} A new instance.
     */
    ...
    this.observe(TP.byId('LamaHalo', consoleGUI.getNativeDocument()),
                    'TP.sig.HaloDidFocus');
...
TP.lama.ConsoleService.Inst.defineMethod('configureKeyboardStateMachine',
function() {
     ...
     * @returns {TP.lama.ConsoleService} The receiver.
     */
    ...
    normalResponder = TP.lama.NormalKeyResponder.construct();
    ...
    autocompleteResponder = TP.lama.AutoCompletionKeyResponder.construct();
...
TP.lama.ConsoleService.Inst.defineMethod('configureSTDIO',
function() {
...
TP.lama.ConsoleService.Inst.defineMethod('isAwaitingInput',
function(aFlag) {
...
TP.lama.ConsoleService.Inst.defineMethod('shouldConcealInput',
function(aFlag) {
...
TP.lama.ConsoleService.Inst.defineHandler('PclassHiddenChange',
function(aSignal) {

    /**
     * @method handlePclassHiddenChangeFromLamaConsole
     * @summary Handles notifications of when the 'hidden' state of the
     *     LamaConsole object changes.
    ...
    //  Install or remove event handlers based on whether the LamaConsole is
    //  being shown or not.
    if (isHidden) {
        this.removeHandlers();
    } else {
...
TP.lama.ConsoleService.Inst.defineHandler('HaloDidBlur',
function(aSignal) {
...
TP.lama.ConsoleService.Inst.defineHandler('HaloDidFocus',
function(aSignal) {
...
TP.lama.ConsoleService.Inst.defineMethod('installHandlers',
function() {
    ...
    //  Lama set up is already complete. Otherwise the core Lama will
    ...
    if (TP.bySystemId('Lama').get('setupComplete')) {
...
TP.lama.ConsoleService.Inst.defineMethod('removeHandlers',
function() {
...
TP.lama.ConsoleService.Inst.defineHandler('DOMMouseMove',
function(aSignal) {
...
TP.lama.ConsoleService.Inst.defineMethod('cancelUserInputRequest',
function(aRequest) {
...
TP.lama.ConsoleService.Inst.defineHandler('ConsoleRequest',
function(aRequest) {
...
TP.lama.ConsoleService.Inst.defineHandler('NoMoreRequests',
function(aRequest) {
...
TP.lama.ConsoleService.Inst.defineHandler('RequestCompleted',
function(aSignal) {
...
TP.lama.ConsoleService.Inst.defineHandler('RequestModified',
function(aSignal) {
...
TP.lama.ConsoleService.Inst.defineHandler('ShellRequestCompleted',
function(aSignal) {
...
TP.lama.ConsoleService.Inst.defineHandler('UserInputRequest',
function(aSignal) {
...
TP.lama.ConsoleService.Inst.defineHandler('UserInputSeries',
function(aSignal) {
...
TP.lama.ConsoleService.Inst.defineHandler('UserOutputRequest',
function(aRequest) {
...
TP.lama.ConsoleService.Inst.defineMethod('refreshFromRequest',
function(aRequest) {
...
TP.lama.ConsoleService.Inst.defineMethod('submitRawInput',
function(anInput) {
...
TP.lama.ConsoleService.Inst.defineHandler('Cancel',
function(anEvent) {
...
TP.lama.ConsoleService.Inst.defineHandler('Change',
function(aSignal) {
...
TP.lama.ConsoleService.Inst.defineHandler('ClearInput',
function(anEvent) {
...
TP.lama.ConsoleService.Inst.defineHandler('HistoryNext',
function(anEvent) {
...
TP.lama.ConsoleService.Inst.defineHandler('HistoryPrev',
function(anEvent) {
...
TP.lama.ConsoleService.Inst.defineHandler('ConsoleInput',
function(aSignal) {
...
TP.lama.ConsoleService.Inst.defineMethod('sendConsoleRequest',
...
TP.lama.ConsoleService.Inst.defineMethod('sendShellRequest',
function(rawInput, options) {
...
TP.lama.ConsoleService.Inst.defineMethod('getModel',
function() {
...
TP.lama.ConsoleService.Inst.defineMethod('getWidth',
function() {
...
TP.lama.ConsoleService.Inst.defineMethod('isShellCommand',
...
TP.lama.ConsoleService.Inst.defineMethod('isSystemConsole',
function(aFlag) {
...
TP.lama.ConsoleService.Inst.defineMethod('setModel',
function(aModel) {
...
TP.lama.ConsoleService.Inst.defineMethod('setWidth',
function(aWidth) {
...
TP.lama.ConsoleService.Inst.defineMethod('notify',
function(anObject, aRequest) {
    ...
    notifier = TP.byId('LamaNotifier', consoleDoc);

    notifier.setStyleProperty(
                '--lama-notifier-fadeout-duration',
                TP.sys.cfg('lama.notifier_fadeout_duration', 5000) + 'ms');
    notifier.setStyleProperty(
                '--lama-notifier-fadeout-delay',
                TP.sys.cfg('lama.notifier_fadeout_delay', 5000) + 'ms');

    notifierContent = TP.byId('LamaNotifierContent', consoleDoc);
    ...
    this.signal(
        'OpenNotifier',
        TP.hc(
            'overlayID', 'LamaNotifier',
            'contentID', 'LamaNotifierContent',
            'noPosition', true,
...
TP.lama.ConsoleService.Inst.defineMethod('stderr',
function(anError, aRequest) {
    ...
    try {
        ...
        TP.ifError() ?
            TP.error(TP.ec(
                        e,
                        TP.join('TP.lama.ConsoleService.stderr(',
...
TP.lama.ConsoleService.Inst.defineMethod('stdin',
...
TP.lama.ConsoleService.Inst.defineMethod('stdout',
function(anObject, aRequest) {
    ...
    if (request.at('cmdSilent') || TP.sys.cfg('lama.silent')) {
    ...
    try {
        ...
        TP.ifError() ?
            TP.error(TP.ec(
                        e,
                        TP.join('TP.lama.ConsoleService.stdout(',
...
TP.lama.ConsoleService.Inst.defineMethod('writeInputContent',
function(aRequest) {
...
TP.lama.ConsoleService.Inst.defineMethod('writeOutputContent',
function(anObject, aRequest) {
    ...
    if (TP.isTrue(request.at('tiledOutput'))) {
        ...
        if (TP.notTrue(asIs) && TP.notTrue(tap)) {
            ...
            data = TP.format(
                    anObject,
                    TP.sys.cfg('lama.default_format', 'lama:pp').asType(),
                    TP.hc('level', 1,
                            'shouldWrap', false));
        } else {
...
//  ========================================================================
//  TP.lama.ConsoleKeyResponder
//  ========================================================================

TP.core.KeyResponder.defineSubtype('TP.lama.ConsoleKeyResponder');

//  ------------------------------------------------------------------------
//  Instance Attributes
//  ------------------------------------------------------------------------

TP.lama.ConsoleKeyResponder.Inst.defineAttribute('$consoleService');
TP.lama.ConsoleKeyResponder.Inst.defineAttribute('$consoleGUI');

//  ------------------------------------------------------------------------
//  Instance Methods
//  ------------------------------------------------------------------------

TP.lama.ConsoleKeyResponder.Inst.defineMethod('isCommandEvent',
function(anEvent) {
...
TP.lama.ConsoleKeyResponder.Inst.defineMethod('isSpecialSignal',
function(aSignal) {
...
//  ========================================================================
//  TP.lama.NormalKeyResponder
//  ========================================================================

TP.lama.ConsoleKeyResponder.defineSubtype('NormalKeyResponder');

//  ------------------------------------------------------------------------
//  Instance Methods
//  ----------------------------------------------------------------------------

TP.lama.NormalKeyResponder.Inst.defineHandler('DOMKeySignal',
function(aSignal) {
...
TP.lama.NormalKeyResponder.Inst.defineHandler('DOM_Ctrl_Down_Up',
function(aSignal) {
...
TP.lama.NormalKeyResponder.Inst.defineHandler('DOM_Ctrl_Up_Up',
function(aSignal) {
...
TP.lama.NormalKeyResponder.Inst.defineHandler('DOM_Down_Down',
function(aSignal) {
...
TP.lama.NormalKeyResponder.Inst.defineHandler('DOM_Up_Down',
function(aSignal) {
...
TP.lama.NormalKeyResponder.Inst.defineHandler('DOM_PageDown_Down',
function(aSignal) {
...
TP.lama.NormalKeyResponder.Inst.defineHandler('DOM_PageUp_Down',
function(aSignal) {
...
TP.lama.NormalKeyResponder.Inst.defineHandler('DOM_Shift_Down_Up',
function(aSignal) {
...
TP.lama.NormalKeyResponder.Inst.defineHandler('DOM_Shift_Up_Up',
function(aSignal) {
...
TP.lama.NormalKeyResponder.Inst.defineHandler('DOM_Ctrl_U_Up',
function(aSignal) {
...
TP.lama.NormalKeyResponder.Inst.defineHandler('DOM_Ctrl_K_Up',
function(aSignal) {
...
TP.lama.NormalKeyResponder.Inst.defineHandler('DOM_Shift_Esc_Up',
function(aSignal) {
...
//  ========================================================================
//  TP.lama.AutoCompletionKeyResponder
//  ========================================================================

TP.lama.NormalKeyResponder.defineSubtype('AutoCompletionKeyResponder');

//  ------------------------------------------------------------------------
//  Instance Attributes
//  ------------------------------------------------------------------------

TP.lama.AutoCompletionKeyResponder.Inst.defineAttribute('hintSelectedIndex');
TP.lama.AutoCompletionKeyResponder.Inst.defineAttribute('currentCompletions');
TP.lama.AutoCompletionKeyResponder.Inst.defineAttribute('completedText');

TP.lama.AutoCompletionKeyResponder.Inst.defineAttribute('$searcher');
TP.lama.AutoCompletionKeyResponder.Inst.defineAttribute('$changeHandler');
TP.lama.AutoCompletionKeyResponder.Inst.defineAttribute(
...
TP.lama.AutoCompletionKeyResponder.Inst.defineMethod('init',
function() {

    /**
     * @method init
     * @summary Constructor for new instances.
     * @returns {TP.lama.AutoCompletionKeyResponder} A new instance.
     */
...
TP.lama.AutoCompletionKeyResponder.Inst.defineHandler('AutocompletionEnter',
function(aSignal) {
...
TP.lama.AutoCompletionKeyResponder.Inst.defineHandler('AutocompletionExit',
function(aSignal) {
     ...
     * @returns {TP.lama.AutoCompletionKeyResponder} The receiver.
     */
...
TP.lama.AutoCompletionKeyResponder.Inst.defineMethod('setHintSelectedIndex',
function(index) {
...
TP.lama.AutoCompletionKeyResponder.Inst.defineHandler('DOM_Down_Down',
function(aSignal) {
...
TP.lama.AutoCompletionKeyResponder.Inst.defineHandler('DOM_Up_Down',
function(aSignal) {
...
TP.lama.AutoCompletionKeyResponder.Inst.defineHandler('DOM_PageDown_Down',
function(aSignal) {
...
TP.lama.AutoCompletionKeyResponder.Inst.defineHandler('DOM_PageUp_Down',
function(aSignal) {
...
TP.lama.AutoCompletionKeyResponder.Inst.defineHandler('DOM_Esc_Up',
function(aSignal) {
...
TP.lama.AutoCompletionKeyResponder.Inst.defineHandler('DOM_Enter_Up',
function(aSignal) {
...
TP.lama.AutoCompletionKeyResponder.Inst.defineHandler('DOM_Tab_Up',
function(aSignal) {
    TP.signal(TP.ANY, 'TP.sig.EndAutocompleteMode', TP.hc('acceptHint', true));
});
...
TP.lama.AutoCompletionKeyResponder.Inst.defineHandler('DOM_Shift_Tab_Up',
function(aSignal) {
...
TP.lama.AutoCompletionKeyResponder.Inst.defineMethod('updateAutoCompletePanel',
function(sourceText) {
...
TP.lama.AutoCompletionKeyResponder.Inst.defineMethod(
...
//  ============================================================================
//  Lama-specific TP.sig.Signal subtypes for the console service
//  ============================================================================
