...
TP.lang.Object.defineSubtype('lama.ToolAPI');

//  ------------------------------------------------------------------------

TP.lama.ToolAPI.Inst.defineMethod('canReuseContentForTool',
...
TP.lama.ToolAPI.Inst.defineMethod('getConfigForTool',
function(toolName, options) {
...
TP.lama.ToolAPI.Inst.defineMethod('getContentForTool',
function(toolName, options) {
...
TP.lama.ToolAPI.Inst.defineMethod('getChildTypeForTool',
function(toolName, options) {
...
TP.lama.ToolAPI.Inst.defineMethod('getDataForTool',
function(toolName, options) {
...
TP.lama.ToolAPI.Inst.defineMethod('getFinalTargetForTool',
function(toolName, options) {
...
TP.lama.ToolAPI.Inst.defineMethod('getPathPartsForTool',
function(toolName, options) {
...
TP.lama.ToolAPI.Inst.defineMethod('resolveAspectForTool',
...
TP.lama.ToolAPI.Inst.defineMethod('canReuseContentForInspector',
function(options) {
...
TP.lama.ToolAPI.Inst.defineMethod('getConfigForInspector',
function(options) {
...
TP.lama.ToolAPI.Inst.defineMethod('getContentForInspector',
function(options) {
...
TP.lama.ToolAPI.Inst.defineMethod('getDataForInspector',
function(options) {
...
TP.lama.ToolAPI.Inst.defineMethod('resolveAspectForInspector',
...
TP.lama.ToolAPI.Inst.defineMethod('getContentForContextMenu',
function(options) {
    ...
    return TP.elem('<lama:elementContextMenuContent/>');
});
...
TP.lama.ToolAPI.Inst.defineMethod('getContentForToolbar',
function(options) {
