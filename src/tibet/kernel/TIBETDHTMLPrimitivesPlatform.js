//  ========================================================================
/*
NAME:   TIBETDHTMLPrimitivesPlatform.js
...
TP.hc(
    ...
    function(aDocument, aURL, aContent, aLoadedFunction) {
        ...
        if (TP.isCallable(aLoadedFunction)) {
            newScriptElement.onreadystatechange =
                function() {

                    //  For script nodes, before IE8, we never seemed to get
                    //  beyond the 'loaded' state, but since then it seems
                    //  we do.
                    if ((newScriptElement.readyState === 'loaded') ||
                        (newScriptElement.readyState === 'complete')) {
                        aLoadedFunction();
                    }
                };
        }
