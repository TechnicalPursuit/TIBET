...
//  input signals.
TP.core.KeyResponder.Inst.defineAttribute('stateMachine');

//  The state that, upon entry, will cause the responder to start listening to
//  the state machine for state changes.
TP.core.KeyResponder.Inst.defineAttribute('mainState');

//  ------------------------------------------------------------------------
//  Instance Methods
//  ------------------------------------------------------------------------

TP.core.KeyResponder.Inst.defineMethod('init',
function(stateMachine) {
     ...
     * @param {TP.core.StateMachine} stateMachine The state machine this
     *     responder should observe.
     * @returns {TP.core.KeyResponder} A new instance.
     */
...
TP.core.KeyResponder.Inst.defineMethod('didEnter',
function(aSignal) {
...
TP.core.KeyResponder.Inst.defineMethod('didExit',
function(aSignal) {
...
TP.core.KeyResponder.Inst.defineMethod('handleStateEnter',
function(aSignal) {
...
TP.core.KeyResponder.Inst.defineMethod('handleStateExit',
function(aSignal) {
...
TP.core.KeyResponder.Inst.defineMethod('handleStateInput',
function(aSignal) {

    /**
     * @method handleStateInput
     * @summary Handles 'input signals' from the state machine. For this type,
     *     these are typically triggered from keyboard-related signals of some
     *     sort.
     * @param {TP.sig.StateInput} aSignal The signal that caused the state
     *     machine to get further input. The original triggering signal (most
     *     likely a keyboard-related signal) will be in this signal's payload
...
TP.core.KeyResponder.Inst.defineMethod('setup',
function() {
