...
TP.definePrimitive('delegate',
function(anInterface, anObject, shouldForce) {

    /**
     * @name delegate
     * @synopsis Iterate over anInterface and install delegation methods on the
     *     object provided. Delegation methods follow a common pattern of:
     *     return this.getDelegate().method(args); which is managed by the
     *     functionality constructed here. If the object implements a
     *     getDelegate() method that method provides the object in question,
     *     otherwise the delegator returns.
     * @param {Array|String} anInterface The method name(s) to install.
     * @param {Object} anObject An optional target object which should receive
     *     the specified methods. When not provided this defaults to
     *     TP.ObjectProto so that the backstops are global.
    ...
    for (i = 0; i < len; i++) {
        ...
        func = Function.constructDelegator(fname);
...
TP.defineMetaInstMethod('getInstMethod',
function(aName) {

    /**
     * @name getInstMethod
     * @synopsis Returns the instance method named, if it exists.
     * @param {String} aName The method name to locate.
     * @returns {Function}
     */

    return TP.method(this, aName, TP.INST_TRACK);
});

//  ------------------------------------------------------------------------

TP.defineMetaInstMethod('getInstMethods',
function() {

    /**
     * @name getInstMethods
     * @synopsis Returns an array of instance methods for the receiver.
     * @returns {Array} An array of function objects.
     * @todo
     */

    return TP.methods(this, TP.INST_TRACK);
});

//  ------------------------------------------------------------------------

TP.defineMetaInstMethod('getLocalMethod',
function(aName) {

    /**
     * @name getLocalMethod
     * @synopsis Returns the local method named, if it exists.
     * @param {String} aName The method name to locate.
     * @returns {Function}
     */

    return TP.method(this, aName, TP.LOCAL_TRACK);
});

//  ------------------------------------------------------------------------

TP.defineMetaInstMethod('getLocalMethods',
function() {

    /**
     * @name getLocalMethods
     * @synopsis Returns an array of local methods for the receiver.
     * @returns {Array} An array of function objects.
     * @todo
     */

    return TP.methods(this, TP.LOCAL_TRACK);
});

//  ------------------------------------------------------------------------

TP.defineMetaInstMethod('getTypeMethod',
function(aName) {

    /**
     * @name getTypeMethod
     * @synopsis Returns the type method named, if it exists. This method
     *     basically defers to the receiver's type.
     * @param {String} aName The method name to locate.
     * @returns {Function}
     */

    return this.getType().getTypeMethod(aName);
});

//  ------------------------------------------------------------------------

TP.defineMetaInstMethod('getTypeMethods',
function() {

    /**
     * @name getTypeMethods
     * @synopsis Returns an array of type methods for the receiver.
     * @returns {Array} An array of function objects.
     * @todo
     */

    return this.getType().getTypeMethods();
});

//  ------------------------------------------------------------------------

TP.defineMetaTypeMethod('getInstMethod',
function(aName) {
    ...
    return TP.method(this.getInstPrototype(), aName, TP.INST_TRACK);
});

//  ------------------------------------------------------------------------

TP.defineMetaTypeMethod('getInstMethods',
function() {
    ...
    return TP.methods(this.getInstPrototype(), TP.INST_TRACK);
});

//  ------------------------------------------------------------------------

TP.defineMetaTypeMethod('getLocalMethod',
function(aName) {
    ...
    return TP.method(this, aName, TP.TYPE_LOCAL_TRACK);
});

//  ------------------------------------------------------------------------

TP.defineMetaTypeMethod('getLocalMethods',
function() {
    ...
    return TP.methods(this, TP.TYPE_LOCAL_TRACK);
});

//  ------------------------------------------------------------------------

TP.defineMetaTypeMethod('getTypeMethod',
function(aName) {

    /**
     * @name getTypeMethod
     * @synopsis Returns the type method named, if it exists.
     * @param {String} aName The method name to locate.
     * @returns {Function}
     */

    if (TP.isType(this)) {
        return TP.method(this, aName, TP.TYPE_TRACK);
    } else {
        return this.getType().getTypeMethod(aName);
    }
});
...
TP.defineMetaTypeMethod('getTypeMethods',
function() {
    ...
    if (TP.isType(this)) {
        return TP.methods(this, TP.TYPE_TRACK);
    } else {
        return this.getType().getTypeMethods();
    }
});
...
TP.lang.RootObject.Type.defineMethod('getInstMethod',
function(aName) {
...
TP.lang.RootObject.Type.defineMethod('getInstMethods',
function() {
...
TP.lang.RootObject.Type.defineMethod('getLocalMethod',
function(aName) {
...
TP.lang.RootObject.Type.defineMethod('getLocalMethods',
function() {
...
TP.lang.RootObject.Type.defineMethod('getTypeMethod',
function(aName) {
...
TP.lang.RootObject.Type.defineMethod('getTypeMethods',
function() {
...
TP.lang.RootObject.Inst.defineMethod('getInstMethod',
function(aName) {
...
TP.lang.RootObject.Inst.defineMethod('getInstMethods',
function() {
...
TP.lang.RootObject.Inst.defineMethod('getLocalMethod',
function(aName) {
...
TP.lang.RootObject.Inst.defineMethod('getLocalMethods',
function() {
...
TP.lang.RootObject.Inst.defineMethod('getTypeMethod',
function(aName) {
...
TP.lang.RootObject.Inst.defineMethod('getTypeMethods',
function() {
