...
TP.core.Unicode.Type.defineConstant('BaseChar',
...
TP.core.Unicode.Type.defineConstant('Ideographic',
        '[\u4E00-\u9FA5]|\u3007|[\u3021-\u3029]');

TP.core.Unicode.Type.defineConstant('Letter',
            TP.join(TP.core.Unicode.BaseChar,
                    '|',
                    TP.core.Unicode.Ideographic));

TP.core.Unicode.Type.defineConstant('CombiningChar',
