...
function() {
    ...
    this.it('Meta objects \'as\' method using externally loaded XML templates', function(test, options) {
        ...
        correctRep = /<span xmlns="http:\/\/www.w3.org\/1999\/xhtml" id="totalTemplate"><span class="estimatedResultCount">Result count: <tibet:acp([\s\S]*)expr="responseData.cursor.resultCount"([\s\S]*)>53,700,000<\/tibet:acp><\/span>Results:<br\/><tibet:acp([\s\S]*)expr="responseData.results"([\s\S]*)>\[object Object\]\[object Object\]\[object Object\]\[object Object\]<\/tibet:acp><\/span>/;
        ...
        correctRep = /<span xmlns="http:\/\/www.w3.org\/1999\/xhtml" id="rowTemplate"><tr class="googleResultRow"><td><tibet:acp([\s\S]*)expr="unescapedUrl"([\s\S]*)>http:\/\/en.wikipedia.org\/wiki\/Dog<\/tibet:acp><\/td><td><tibet:acp([\s\S]*)expr="title"([\s\S]*)><b>Dog<\/b> - Wikipedia, the free encyclopedia<\/tibet:acp><\/td><td><tibet:acp([\s\S]*)expr="content"([\s\S]*)>The domestic <b>dog<\/b> \(Canis lupus familiaris\) is a subspecies of the gray wolf \(Canis lupus\), a member of the Canidae family of the mammalian order Carnivora\.<\/tibet:acp><\/td><\/tr><\/span>/;
    ...
    this.it('Meta objects \'as\' method using externally loaded XSLT templates', function(test, options) {
        ...
        //  If we're running in Gecko, the output will be slightly different - but
        //  it's still correct.
    ...
    this.it('Meta objects \'as\' method using logic-control helpers', function(test, options) {
        ...
        correctRep = '<ul><tibet:acp expr="foo.bar"><li>googoo</li><li>moomoo</li></tibet:acp></ul>';
        ...
        correctRep = '<ul><tibet:acp expr="foo.bar"><li>googoo</li><li>moomoo</li></tibet:acp></ul> and then there\'s: <tibet:acp expr="foo.bar.moo">moomoo</tibet:acp>';
        ...
        correctRep = '<ul><tibet:acp expr="foo.bar"></tibet:acp></ul> and then there\'s: <tibet:acp expr="foo.bar.moo"></tibet:acp>';
        ...
        correctRep = '<ul><tibet:acp expr="foo.bar"><li>This is goo: googoo</li></tibet:acp></ul>';
        ...
        correctRep = '<ul><tibet:acp expr="foo.bar"><li>This is moo: moomoo</li></tibet:acp></ul>';
        ...
        correctRep = '<ul><tibet:acp expr="foo"><li><span>googoo1</span><span>moomoo1</span></li><li><span>googoo2</span><span>moomoo2</span></li></tibet:acp></ul>';
