...
function() {
    ...
    correctValues = TP.hc(
        ...
        'TP.core.SimpleTIBETPath',              '[object Object]',
        'TP.core.ComplexTIBETPath',             '[object Object]',
        'TP.core.ElementPath',                  '[object Object]',
        'TP.core.XTensionPath',                 '[object Object]',
        'TP.core.XPathPath',                    '[object Object]',
...
function() {
    ...
    correctValues = TP.hc(
        ...
        'TP.core.SimpleTIBETPath',  'foo',
        'TP.core.ComplexTIBETPath', 'foo.bar.baz',
        'TP.core.ElementPath',      '/1/2',
        'TP.core.XTensionPath',     '*[foo]',
        'TP.core.XPathPath',        '//*',
...
function() {
    ...
    correctValues = TP.hc(
        ...
        'TP.core.SimpleTIBETPath',  '[TP.core.SimpleTIBETPath :: (foo)]',
        'TP.core.ComplexTIBETPath', '[TP.core.ComplexTIBETPath :: (foo.bar.baz)]',
        'TP.core.ElementPath',      '[TP.core.ElementPath :: (/1/2)]',
        'TP.core.XTensionPath',     '[TP.core.XTensionPath :: (*[foo])]',
        'TP.core.XPathPath',        '[TP.core.XPathPath :: (//*)]',
...
function() {
    ...
    correctValues = TP.hc(
        ...
        'TP.core.SimpleTIBETPath',  '<span class="TP_core_AccessPath TP_core_SimpleTIBETPath">foo</span>',
        'TP.core.ComplexTIBETPath', '<span class="TP_core_AccessPath TP_core_ComplexTIBETPath">foo.bar.baz</span>',
        'TP.core.ElementPath',      '<span class="TP_core_AccessPath TP_core_ElementPath">/1/2</span>',
        'TP.core.XTensionPath',     '<span class="TP_core_AccessPath TP_core_XTensionPath">*[foo]</span>',
        'TP.core.XPathPath',        '<span class="TP_core_AccessPath TP_core_XPathPath">//*</span>',
...
function() {
    ...
    correctValues = TP.hc(
        ...
        'TP.core.SimpleTIBETPath',  '<instance type="TP.core.SimpleTIBETPath" path="foo"/>',
        'TP.core.ComplexTIBETPath', '<instance type="TP.core.ComplexTIBETPath" path="foo.bar.baz"/>',
        'TP.core.ElementPath',      '<instance type="TP.core.ElementPath" path="/1/2"/>',
        'TP.core.XTensionPath',     '<instance type="TP.core.XTensionPath" path="*[foo]"/>',
        'TP.core.XPathPath',        '<instance type="TP.core.XPathPath" path="//*"/>',
...
function() {
    ...
    correctValues = TP.hc(
        ...
        'TP.core.SimpleTIBETPath',  '<dl class="pretty TP_core_SimpleTIBETPath"><dt>Type name</dt><dd class="pretty typename">TP.core.SimpleTIBETPath</dd><dt class="pretty key">Path:</dt><dd class="pretty value">foo</dd></dl>',
        'TP.core.ComplexTIBETPath', '<dl class="pretty TP_core_ComplexTIBETPath"><dt>Type name</dt><dd class="pretty typename">TP.core.ComplexTIBETPath</dd><dt class="pretty key">Path:</dt><dd class="pretty value">foo.bar.baz</dd></dl>',
        'TP.core.ElementPath',      '<dl class="pretty TP_core_ElementPath"><dt>Type name</dt><dd class="pretty typename">TP.core.ElementPath</dd><dt class="pretty key">Path:</dt><dd class="pretty value">/1/2</dd></dl>',
        'TP.core.XTensionPath',     '<dl class="pretty TP_core_XTensionPath"><dt>Type name</dt><dd class="pretty typename">TP.core.XTensionPath</dd><dt class="pretty key">Path:</dt><dd class="pretty value">*[foo]</dd></dl>',
        'TP.core.XPathPath',        '<dl class="pretty TP_core_XPathPath"><dt>Type name</dt><dd class="pretty typename">TP.core.XPathPath</dd><dt class="pretty key">Path:</dt><dd class="pretty value">//*</dd></dl>',
...
function() {
    ...
    correctValues = TP.hc(
        ...
        'TP.core.SimpleTIBETPath',  '{"type":"TP.core.SimpleTIBETPath","data":"foo"}',
        'TP.core.ComplexTIBETPath', '{"type":"TP.core.ComplexTIBETPath","data":"foo.bar.baz"}',
        'TP.core.ElementPath',      '{"type":"TP.core.ElementPath","data":"/1/2"}',
        'TP.core.XTensionPath',     '{"type":"TP.core.XTensionPath","data":"*[foo]"}',
        'TP.core.XPathPath',        '{"type":"TP.core.XPathPath","data":"//*"}',
