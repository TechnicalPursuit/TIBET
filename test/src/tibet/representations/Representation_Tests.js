...
function() {
    ...
    correctValues = TP.hc(
        ...
        'AsyncFunction',        /\[AsyncFunction :: async function ([\s\S]+)\]/,
        'GeneratorFunction',    /\[GeneratorFunction :: function\* ([\s\S]+)\]/,
        'NaN',                  '[Number :: NaN]',
        ...
        'WeakMap',              '[WeakMap :: [object WeakMap]]',
        'WeakSet',              '[WeakSet :: [object WeakSet]]',
        ...
        'TIBETType.Type',               '[Function :: TP.dom.Node.Type]',
        'TIBETType.Inst',               '[Function :: TP.dom.Node.Inst]',
...
function() {
    ...
    correctValues = TP.hc(
        ...
        'NativeFunction',       /function\s*slice\(\)\s*{\s*\[native code\]\s*}/,
        'Symbol',               '<span class="Symbol">foo</span>',
        'Map',                  '<span class="Map"><span data-name="foo">bar</span></span>',
        'Set',                  '<span class="Set"><span data-name="0">1</span><span data-name="1">2</span><span data-name="2">3</span></span>',
        'WeakMap',              '<span class="WeakMap"></span>',
        'WeakSet',              '<span class="WeakSet"></span>',
        ...
        'TIBETType.Type',               '<span class="Function">TP.dom.Node.Type</span>',
        'TIBETType.Inst',               '<span class="Function">TP.dom.Node.Inst</span>',
...
function() {
    ...
    correctValues = TP.hc(
        ...
        'NativeFunction',       /function\s*slice\(\)\s*{\s*\[native code\]\s*}/,
        'Symbol',               '<instance type="Symbol">foo</instance>',
        'Map',                  '<instance type="Map"><foo>bar</foo></instance>',
        'Set',                  '<item index="0">1</item><item index="1">2</item><item index="2">3</item>',
        'WeakMap',              '<instance type="WeakMap"></instance>',
        'WeakSet',              '<instance type="WeakSet"></instance>',
        ...
        'TIBETType',                    '<type>TP.dom.Node</type>',
        'TIBETType.Type',               '<instance type="Function">TP.dom.Node.Type</instance>',
        'TIBETType.Inst',               '<instance type="Function">TP.dom.Node.Inst</instance>',
...
function() {
    ...
    correctValues = TP.hc(
        ...
        'AsyncFunction',        /<dl class="pretty AsyncFunction"><dt\/><dd>async function\s*\(\s*\)\s*{return\s*"async fluffy"\s*;?\s*}<\/dd><\/dl>/,
        'GeneratorFunction',    /<dl class="pretty GeneratorFunction"><dt\/><dd>function\s*\*\(\s*\)\s*{return\s*"generator fluffy"\s*;?\s*}<\/dd><\/dl>/,
        'NaN',                  'NaN',
        ...
        'Symbol',               '<dl class="pretty Symbol"><dt\/><dd>foo<\/dd><\/dl>',
        'Map',                  '<dl class="pretty Map"><dt>Type name</dt><dd class="pretty typename">Map</dd><dt class="pretty key">foo</dt><dd class="pretty value"><dl class="pretty String"><dt/><dd>bar</dd></dl></dd></dl>',
        'Set',                  '<dl class="pretty Set"><dt>Type name</dt><dd class="pretty typename">Set</dd><dt class="pretty key">0</dt><dd class="pretty value"><dl class="pretty Number"><dt/><dd>1</dd></dl></dd><dt class="pretty key">1</dt><dd class="pretty value"><dl class="pretty Number"><dt/><dd>2</dd></dl></dd><dt class="pretty key">2</dt><dd class="pretty value"><dl class="pretty Number"><dt/><dd>3</dd></dl></dd></dl>',
        'WeakMap',              '<dl class="pretty WeakMap"><dt>Type name</dt><dd class="pretty typename">WeakMap</dd></dl>',
        'WeakSet',              '<dl class="pretty WeakSet"><dt>Type name</dt><dd class="pretty typename">WeakSet</dd></dl>',
        ...
        'TIBETType.Type',               '<dl class="pretty Function"><dt>Type name</dt><dd class="pretty typename">Function</dd><dt class="pretty key">Content</dt><dd class="pretty value">TP.dom.Node.Type</dd></dl>',
        'TIBETType.Inst',               '<dl class="pretty Function"><dt>Type name</dt><dd class="pretty typename">Function</dd><dt class="pretty key">Content</dt><dd class="pretty value">TP.dom.Node.Inst</dd></dl>',
...
function() {
    ...
    correctValues = TP.hc(
        ...
        'TIBETType.Type',               '{"type":"Function","data":"TP.dom.Node.Type"}',
        'TIBETType.Inst',               '{"type":"Function","data":"TP.dom.Node.Inst"}',
