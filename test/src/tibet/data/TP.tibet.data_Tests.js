...
function() {
    ...
    this.it('No specific result type - non-mutable content', async function(test, options) {
        ...
        await test.getDriver().setLocation(unloadURI);
    ...
    this.it('Specific result type - non-mutable content', async function(test, options) {
    ...
    this.it('No specific result type - XML content', async function(test, options) {
    ...
    this.it('Specific result type - XML content', async function(test, options) {
    ...
    this.it('No specific result type - JSON content', async function(test, options) {
    ...
    this.it('Specific result type - JSON content', async function(test, options) {
...
function() {
    ...
    this.it('No specific result type - XML content then resetting via setContent()', async function(test, options) {
    ...
    this.it('No specific result type - JSON content then resetting via setContent()', async function(test, options) {
...
function() {
    ...
    this.it('Auto-creation within existing structure - XML content', async function(test, options) {
    ...
    this.it('Auto-creation within existing structure - JSON content', async function(test, options) {
    ...
    this.it('Auto-creation into no existing structure - XML content', async function(test, options) {
    ...
    this.it('Auto-creation into no existing structure - JSON content', async function(test, options) {
