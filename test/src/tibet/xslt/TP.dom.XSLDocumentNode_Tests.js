...
function() {
    ...
    this.it('simple XSL transformation', async function(test, options) {
        ...
        tpXSLTDoc = await test.getDriver().fetchResource(
                            loadURI, TP.hc('resultType', TP.WRAP));
    ...
    this.it('XSL transformation with parameters - using default values', async function(test, options) {
    ...
    this.it('XSL transformation with parameters - supply scalar values', async function(test, options) {
    ...
    this.it('XSL transformation with parameters - supply node values', async function(test, options) {
