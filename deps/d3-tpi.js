!function() {
  ...
  function d3_selection_style(name, value, priority) {
    function styleNull() {
      TP.elementGetStyleObj(this).removeProperty(name);
    }
    function styleConstant() {
      TP.elementGetStyleObj(this).setProperty(name, value, priority);
    }
    function styleFunction() {
      var x = value.apply(this, arguments);
      if (x == null) TP.elementGetStyleObj(this).removeProperty(name); else TP.elementGetStyleObj(this).setProperty(name, x, priority);
    }
  ...
  d3_transitionPrototype.styleTween = function(name, tween, priority) {
    ...
    function styleTween(d, i) {
      ...
      return f && function(t) {
        TP.elementGetStyleObj(this).setProperty(name, f(t), priority);
      };
    }
