...
TP.core.UIElementNode.registerKeybinding('DOM_Ctrl_RightCurlyBracket_Down',
    'TP.sig.UIFocusFollowing');
TP.core.UIElementNode.registerKeybinding('DOM_Ctrl_LeftCurlyBracket_Down',
...
TP.core.UIElementNode.registerKeybinding('DOM_Ctrl_RightSquareBracket_Down',
    'TP.sig.UIFocusFirstInNextGroup');
TP.core.UIElementNode.registerKeybinding('DOM_Ctrl_LeftSquareBracket_Down',
