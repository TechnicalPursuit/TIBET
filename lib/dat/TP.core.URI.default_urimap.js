...
TP.sys.setcfg('uri.map.sabredav.urihandler', 'TP.core.WebDAVHandler');
...
TP.sys.setcfg('uri.map.couchdb.urihandler', 'TP.couchdb.CouchDBURLHandler');

TP.sys.setcfg('uri.map.couchnoext.pattern', 'http://.*:5984.*\\/[^.\\?]*$');
TP.sys.setcfg('uri.map.couchnoext.urihandler', 'TP.couchdb.CouchDBURLHandler');
TP.sys.setcfg('uri.map.couchnoext.contenttype', 'TP.core.JSONContent');

TP.sys.setcfg('uri.map.localhost.pattern', 'http://localhost.*');
TP.sys.setcfg('uri.map.localhost.urihandler', 'TP.tds.TDSURLHandler');

TP.sys.setcfg('uri.map.localip.pattern', 'http://127.0.0.1.*');
TP.sys.setcfg('uri.map.localip.urihandler', 'TP.tds.TDSURLHandler');
