			...
			<body>
				<table xmlns="http://www.w3.org/1999/xhtml" cellpadding="3" cellspacing="0" class="uor_table inspectortable">
					<thead class="uor_table_title">
						<tr><td>Element Inspector: <xsl:value-of select="$objectRef"/></td><td><span class="buttonText" onclick="expandAll()">Expand All</span>&#160;&#160;&#160;<span class="buttonText" onclick="collapseAll()">Collapse All</span></td></tr>
					</thead>
