			...
			<body>
				<table xmlns="http://www.w3.org/1999/xhtml" cellpadding="3" cellspacing="0" class="uor_table">
					<thead class="uor_table_title">
						<tr><td>Non-TIBETan Object Inspector: <xsl:value-of select="$objectRef"/></td><td><span class="buttonText" onclick="expandAll()">Expand All</span>&#160;&#160;&#160;<span class="buttonText" onclick="collapseAll()">Collapse All</span></td></tr>
					</thead>
		...
		<tr xmlns="http://www.w3.org/1999/xhtml">
			...
			<td>
				<xsl:choose>
					...
					<xsl:otherwise>
						<textarea rows="{$numRows}" style="width: 80%; height: {concat($numRows,'.5em')}" onchange="{$fullWindowName}.$shell('{$objectRef}[&quot;{name}&quot;] = &quot;' + this.value + '&quot;',true,true,null,&quot;TSH&quot;);" onclick="switchNode(this); return false;" class="valueText" collapsed="true">
							<xsl:value-of select="value"/>
						</textarea>
					</xsl:otherwise>
				</xsl:choose>
